...
```bash
git remote add encore encore://agile-squad-attendance-management-platform-w9b2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/agile-squad-attendance-management-platform-w9b2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/agile-squad-attendance-management-platform-w9b2/settings/integrations/github)
